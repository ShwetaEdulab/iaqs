...
template: `
<nb-card class="col-xl-6 offset-xl-3" [style.height.px]="800" [style.width.px]="1500" accent="success" size="xsmall" [nbSpinner]="loading" nbSpinnerStatus="success" nbSpinnerSize="xlarge"> 
<nb-card-header>
<div class="row">
