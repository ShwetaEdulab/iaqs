    ...
    <nb-card status="success">
        ...
        <nb-card-body>
            <nb-tabset fullWidth>
				...
				<div class="row">
               <div class="col-lg-4">
               <input type="text" (keyup)="startSearch('Search','')" class="form-control" [(ngModel)]="Input_Search"  id="inputFirstName"  placeholder="Search School Name">
					      </div>	
				        <div class="col-lg-4">	
                <mat-form-field>
              ...
              <div class="col-md-12">
                  <nb-card size="large">
                      <nb-list>
                          ...
                          <nb-list-item *ngFor="let college of colleges?.school_info" style="padding: 0;">
