  ...
  async ngOnInit() {
    ...
    PaymentDetails.subscribe(
      data => {
        ...
        var generatereceipt =  this.api.OnlinePaymentChallan('2',this.transaction_id,this.payment_amount,this.payment_status,this.application_id,this.payment_date_time,this.enrollment_no,this.user_id);
        generatereceipt.subscribe(
          data => {
            var value = this.application_id+'_Second_Online_Payment_Challan.pdf';
